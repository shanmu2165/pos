...
class Shows extends BaseController {
    ...
    function details($id=NULL,$etime=NULL) {
        ...
        $data['etime'] = $etime;
      //echo "<pre>"; print_r($additional_details); "<pre/>"; die;
        //$time = array_column($data['additional_details'],'start_time');
    ...
    function print_tickets() {
      ...
      try {
        ...
        $connector = new WindowsPrintConnector("smb://DESKTOP-P1BOFH0/Receipt");
        ...
        /* Close printer */
        $printer->close();
        //echo "<pre>"; print_r($printer); "</pre>"; die;
        echo "Success"; die;
      } catch (Exception $e) {
        echo "Failure"; die;
    ...
    //Twilio Sms Function 
    function send_sms($no = '+917012405595',$body= NULL) {
